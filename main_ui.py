...
"}")
        ...
        self.fanSpeed = QLabel(self.groupBox_3)
        self.fanSpeed.setObjectName(u"fanSpeed")
        self.fanSpeed.setMinimumSize(QSize(40, 0))
        self.fanSpeed.setMaximumSize(QSize(30, 16777215))
        font12 = QFont()
        font12.setPointSize(9)
        font12.setBold(False)
        self.fanSpeed.setFont(font12)

        self.gridLayout_3.addWidget(self.fanSpeed, 1, 1, 1, 1)
...
"\u0417\u0434\u0435\u0441\u044c \u0441\u043a\u043e\u0440\u043e \u0447\u0442\u043e-\u0442\u043e \u0431\u0443\u0434\u0435\u0442!", None))
        ...
        self.fanSpeed.setText(QCoreApplication.translate("MainWindow", u"50%", None))
